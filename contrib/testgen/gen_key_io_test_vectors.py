...
bech32_templates = [
  ...
  ('"bilcoin',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('"bilcoin',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('"bilcoin',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbilc',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbilc',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbilc',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbilc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbilc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbilc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbilc',   17, 32, False, False, False),
  ('rbilc',  3,  1, False, False, False),
  ('bilcoin',   15, 41, False, False, False),
  ('tbilc',    0, 16, False, False, False),
  ('rbilc',  0, 32, True,  False, False),
  ('bilcoin',    0, 16, True,  False, False),
  ('tbilc',    0, 32, False, True,  False),
  ('rbilc',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['bilcoin', 'tbilc', 'rbilc']:
