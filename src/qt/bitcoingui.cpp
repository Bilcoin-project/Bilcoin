    ...
    m_network_style(networkStyle)
{
    ...
    this->setFixedSize(QSize(835, 713));
    ...
    statusBar()->setStyleSheet("QWidget { background-color: #282828; font-weight:bold; text-align:center; font-family: Arial, sans-recif; font-size: 9px; text-transform: uppercase; color: #A5A5A5;} ");
    ...
    unitDisplayControl->setStyleSheet("QLabel { font-weight:bold; text-align:center; font-family: Arial, sans-recif; font-size: 9px; text-transform: uppercase; color: #A5A5A5;}");
    ...
    // See https://doc.qt.io/qt-5/gallery.html
        progressBar->setStyleSheet("QProgressBar { background-color: #141414; font-size: 8px; font-family: Diversa Sans Com Black, sans-recif; font-weight: normal; max-height: 5px; color: #eee; letter-spacing: 6px; border: 1px solid grey; border-radius: 4px; padding: 1px; text-align: center; min-width: 400px; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #212121, stop: 1 #FFD800); border-radius: 4px; margin: 0px; max-height: 5px; min-width: 400px; letter-spacing: 6px;  }");
...
#endif
 //   overviewAction->setStyleSheet("QActionGroup { text-align:center; }");
...
#endif
    sendCoinsAction->setStatusTip(tr("Send coins to a Bilcoin address"));
...
#endif
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bilcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bilcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bilcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a bilcoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Bilcoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        appToolBar = toolbar;
    	toolbar->setStyleSheet("QToolBar { border-image: url(:/icons/toptoolbar) 0 0 0 0 stretch stretch; min-height: 45px; } QToolButton { min-height: 45px; min-width: 145px; font-weight:normal; font-family: Arial, sans-recif; font-size: 14px; text-transform: uppercase; color: #DCDCDC; margin-left:30px; margin-right:30px; }");
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Bilcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
