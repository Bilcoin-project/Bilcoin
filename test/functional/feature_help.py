...
"""Verify that starting bilcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bilcoin with -h for help text")
        ...
        self.log.info("Start bilcoin with -version for version information")
        ...
        self.log.info("Start bilcoind with -fakearg to make sure it does not start")
